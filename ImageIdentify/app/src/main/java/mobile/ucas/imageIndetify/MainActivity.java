package mobile.ucas.imageIndetify;
...
import mobile.ucas.imageIndetify.ternsorflow.Classifier;
import mobile.ucas.imageIndetify.ternsorflow.TFImageClassifier;
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    MessageQueue.IdleHandler idleHandler = new MessageQueue.IdleHandler() {
        ...
        public boolean queueIdle() {
            ...
            if (classifier == null) {
                // 创建 Classifier
               classifier = TFImageClassifier.create(MainActivity.this.getAssets(),
    ...
    private void openSystemCamera() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            currentTakePhotoUri = FileProvider.getUriForFile(this, "mobile.ucas.imageIndetify.fileprovider", photoFile);
